...
//
// A userspace buffer can be useful in situations where the kernel buffer can't
// be increased and there is a (very) large number of events. For almost all use
// cases an unbuffered Watcher – as created by [NewWatcher] – will perform
// better.
//
// You will always be better off increasing the kernel buffers if at all
// possible; most kernels have de-duplication logic which allows for less
// activity in userspace and better performance.
